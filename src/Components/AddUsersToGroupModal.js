...
export class AddUsersToGroupModal extends Component{
    ...
    getUsers() {
        fetch('https://sqwid20210420111837.azurewebsites.net/api/' +'groups/users/' + this.state.groupId)
    ...
    handleSubmit(event){
        ...
        fetch('https://sqwid20210420111837.azurewebsites.net/api/groups/addusers/' + this.state.groupId,{
            method:'POST',
            headers:{
