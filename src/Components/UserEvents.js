...
export class UserEvents extends Component {
    ...
    getActiveUserEvents() {
        ...
        fetch('https://sqwid20210420111837.azurewebsites.net/api/events/active/user/' + userId) //'https://sqwid20210420111837.azurewebsites.net/api/'
    ...
    getPastUserEvents() {
        ...
        const userToken = JSON.parse(tokenString);
        const userId = userToken?.token;
        fetch('https://sqwid20210420111837.azurewebsites.net/api/events/past/user/' + userId) //'https://sqwid20210420111837.azurewebsites.net/api/'
            .then(response => response.json())
            .then(data => {
