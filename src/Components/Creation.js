...
export class Creation extends Component {
    ...
    getEventCreations() {
        fetch('https://sqwid20210420111837.azurewebsites.net/api/creations/event/' + this.eventId)
        ...
        return (
            <div style={{width:"100%", display:"flow-root"}}>
                ...
                <Card style={{ width: '18rem' }}>
                    <Card.Img variant="top" src={'https://sqwid20210420111837.azurewebsites.net/Photos/' + creation.CreationImagePath} />
                    <Card.Body>
