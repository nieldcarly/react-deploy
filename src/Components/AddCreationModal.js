...
export class AddCreationModal extends Component{
    ...
    imageSource = 'https://sqwid20210420111837.azurewebsites.net/Photos/' + this.photoFileName;

    componentDidMount(){
        fetch('https://sqwid20210420111837.azurewebsites.net/api/creations')
    ...
    handleFileSelected(event){
        ...
        fetch('https://sqwid20210420111837.azurewebsites.net/api/creations/savefile',{
            method:'POST',
            body:formData
        })
        .then(res=>res.json())
        .then((result)=>{
            this.imageSource = 'https://sqwid20210420111837.azurewebsites.net/Photos/'+result;
        },
        (error)=>{
            alert('Failed');
        })
